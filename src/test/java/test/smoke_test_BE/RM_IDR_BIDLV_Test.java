...
public class RM_IDR_BIDLV_Test extends BrowserManager {
    ...
    public void RM_CR_BCRLV_1(Method testMethodName) throws InterruptedException, IOException {
        ...
        RM_IDR_BIDLV bcc = PageFactory.initElements(driver, RM_IDR_BIDLV.class);
       logStep( "Steps performed according to RM_ODR_BODRLV Test Cases");
        openBEUrl();
        logStep("Locating Reports");
        bcc.locateReports();
        logStep("Selecting Individual Donor Report");
