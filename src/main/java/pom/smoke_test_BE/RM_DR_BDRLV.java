...
public class RM_DR_BDRLV extends BrowserManager {
    ...
    Properties BCPRLV = loader.getProperties("RM_DR_BDRLVLocators.properties");
    ...
    public void selectReportsDropdown()
    {
        ...
        dropdown.selectByValue("jgivedonors");
    }
