...
public class RM_IDR_BIDLV extends BrowserManager {
    ...
    Properties BCPRLV = loader.getProperties("RM_IDR_BIDLVLocators.properties");
    ...
    public void selectReportsDropdown()
    {
        ...
        dropdown.selectByValue("jgivedonorindividual");
    }
